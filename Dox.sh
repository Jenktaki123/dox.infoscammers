...
echo -e -n "${verde}
┌═════════════════════════════════════┐
█ ${blanco}SELECT AN OPTION AND PRESS ENTER ${verde}█
└═════════════════════════════════════┘

┌═════════════════════════════════════════════════════════┐
█ [${blanco}1${verde}] ${blanco}ddos       ${verde}┃ [${blanco}10${verde}] ${blanco}Sentinel     ${verde}┃ [${blanco}19${verde}] ${blanco}sanctions     ${verde}█
█═════════════════════════════════════════════════════════█
█ [${blanco}2${verde}] ${blanco}rot13      ${verde}┃ [${blanco}11${verde}] ${blanco}ExifData     ${verde}┃ [${blanco}20${verde}] ${blanco}Sat           ${verde}█
█═════════════════════════════════════════════════════════█
...
case $Opcion_DoxWeb in
	1)
		termux-open https://stresser.org/
		;;
	2)
		termux-open https://rot13.com/
		;;
	3)
...
echo -e -n "${verde}
┌═════════════════════════════════════┐
█ ${blanco}¿YOU WANT TO USE THE SCRIPT AGAIN? ${verde}█
└═════════════════════════════════════┘
...
echo -e "${verde}
┌════════════════════════════════┐
█ ${blanco}USE THE SCRIPT AGAIN ${verde}█
█ ${blanco}RUN THE COMMAND ./DoxWeb.sh ${verde}█
└════════════════════════════════┘
"${blanco}
esac
